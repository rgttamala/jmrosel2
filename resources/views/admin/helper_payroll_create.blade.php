...
<input type="hidden" style="width: 170px" name="sss" id="sss" value="{{$helper->sss}}" class="form-control col-sm-4" readonly>
<input type="hidden" style="width: 170px" name="philhealth" id="philhealth" value="{{$helper->philhealth}}" class="form-control col-sm-4" readonly>  
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        <hr>
        <td>
            <input type="date" name="tripdate[]" style="width: 170px" id="tripdate" class="form-control" required> 
        </td>

        ...
        {{ method_field('PATCH') }}
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <br><br>
                        <legend>{{$payroll->user->name}}</legend>
                        </div>
                        <!-- panel preview -->
                        <div class="col-sm-5">
                            <h4>Add payment:</h4>
                             ...
                             <div class="panel panel-default">
                                <div class="panel-body form-horizontal payment-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="date" class="form-control" id="payperiodstart" value="{{$payroll->payperiodstart}}" name="payperiodstart">
                                        </div>
                                    </div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="payperiodend" value="{{$payroll->payperiodend}}" name="payperiodend">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="workedhours" value="{{$payroll->workedhours}}" name="workedhours">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="amount" value="{{$payroll->cashadvance}}" name="cashadvance">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="salary" name="salary" value="{{$payroll->salary}}" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="number" class="form-control" id="sss" name="sss" value="{{$payroll->sss}}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="number" class="form-control" id="philhealth" name="philhealth" value="{{$payroll->philhealth}}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="deductions" value="{{$payroll->deductions}}" name="deductions">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="amount" class="col-sm-3 control-label">Deduction Remarks</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="deductions" value="{{$payroll->deductionremarks}}" name="deductions">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="status" name="status" value="{{$payroll->status}}" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="dateissued" value="{{$payroll->dateissued}}" name="dateissued">
                                        </div>
                                    </div>   
                                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block">Update all and Save</button>
                                </div>                
                            </div>

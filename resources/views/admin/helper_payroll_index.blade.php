            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <div class="col-lg-12">
                            <h1 class="page-header">Payroll List: <strong>{{ $helper->helpername }}	</strong>
                                <!--input type="text" id="filterInput" onkeyup="filterFunction()" placeholder="Search Employees...."-->
                            </h1>	
                        </div>
                    
                        <a href="{{ route('helperpayrolls.create', ['id'=>$helper->id]) }}" class="btn btn-primary">Create</a>
                    </div>
                    <div class="box-body">
                        <table class= "table table-hover" id="filterTable">
                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <td>
                                    <a href="{{ route('helperpayrolls.receipt', ['id' => $indexpayroll->id]) }}" data-toggle="modal" class="btn btn-sm edit btn-flat"><i class='fa fa-eye'></i> View</a>
                                </td>  
